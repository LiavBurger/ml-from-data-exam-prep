...
// ═══════════════════════════════════════════════════════════════ 1 REGRESSION
{
  id: "regression", num: 1, title: "Regression",
...
{
  id: "linclass", num: 2, title: "Linear classification",
...
// ═══════════════════════════════════════════════════════════════ 3 SVM & KERNELS
{
  id: "svm", num: 3, title: "Max-margin, SVM & kernels",
...
// ═══════════════════════════════════════════════════════════════ 4 BAYES
{
  id: "bayes", num: 4, title: "Bayes: MLE, MAP, costs",
...
// ═══════════════════════════════════════════════════════════════ 5 CLUSTERING
{
  id: "clustering", num: 5, title: "Clustering",
...
// ═══════════════════════════════════════════════════════════════ 7 TREES
{
  id: "trees", num: 7, title: "Decision trees",
